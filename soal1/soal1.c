...
char *drive[] = {"https://drive.google.com/file/d/1ZG8nRBRPquhYXq_sISdsVcXx5VdEgi-J/view", "https://drive.google.com/file/d/1ktjGgDkL0nNpY-vT7rT7O6ZI47Ke9xcp/view", "https://drive.google.com/file/d/1FsrAzb9B5ixooGUs0dGiBr-rC7TS9wTD/view"};
...
{    
	...
	if(stepmove == 0)
	{
		if(isFolder == 1)
		{
    		char *argv[] = {"find", xtrctd[0], "-type", "f", "-exec", "mv", "{}", dir[1], ";", NULL};
    		execv("/usr/bin/find", argv);
		}
	    else if(isFolder == 2)
		{
			char *argv[] = {"find", xtrctd[1], "-type", "f", "-exec", "mv", "{}", dir[2], ";", NULL};
    		execv("/usr/bin/find", argv);
		}
   		else if(isFolder == 3)
    	{
    		char *argv[] = {"find", xtrctd[2], "-type", "f", "-exec", "mv", "{}", dir[3], ";", NULL};
    		execv("/usr/bin/find", argv);
		}
	}
	else
...
void function2()
{
	...
	if(function2 == 0)
	{
		...
		{
			char *argv[] = {"zip", "-mr", dir[4], nama[0], nama[1], nama[2], NULL};
